    ...
    return (
        <div className='w-96 min-h-fit h-[91vh] bg-blue-200 absolute right-0  top-16 px-5 pt-2  flex flex-col justify-between '>
            <div>
                ...
                <textarea name="issuebox" id="" className='w-full mt-4 px-1 border-2 border-black' placeholder='describe your issue' rows={7} ></textarea>
                <p className='text-red-700'>*Do not add any sensitive information.</p>
            </div>

            <div >
                <p className='text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi ipsa dolorum velit quod quidem quae sed voluptatem, commodi odio! Blanditiis repudiandae expedita quam atque ea deleniti eaque ullam veritatis</p>
